...
const BusinessGroup = () => {
  const title = "Estamos en construcción, vuelve pronto";
  const message1 = "aquí podrás conocer mucho sobre enviexpress y sus políticas";
  const message2 = "estamos para ayudarte";
