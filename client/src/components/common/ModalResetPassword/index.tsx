...
export default function ModalResetPassword({ open, close }: Props) {
            ...
            {responseReset == "" ? (
              <>
                <form onSubmit={handleSubmit(handleSubmitResetPassword)}>
                  ...
                  <div className="md:flex md:flex-wrap">
                    ...
                    <span className="form-login-error">
                      {responseError === "auth/user-not-found" &&
              ...
              <>
                ...
                <h1 className="my-2 text-2xl font-extrabold tracking-tight leading-tight text-center">
                  Hemos enviado un correo para que puedas recuperar tu
                  contraseña
                </h1>
