...
function index({ file, fileName, handleChangeFile, required }: any) {
  return (
    <>
      <label className=" my-4 text-base font-semibold dark:text-white">
        Cargar Archivo
      </label>
      {/* input */}
          ...
          {file == "" ? (
            <div className="flex flex-col items-center justify-center pt-5 pb-6 ">
              ...
              <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                <span className="font-semibold">Click aqui</span> para subir
                archivo
              </p>
            </div>
          ) : (
